  ...
  const projects = [
    {
      ...
      description: 'An end-to-end framework for de novo antibody design utilizing diffusion-based generative models. It optimizes sequences using graph neural networks and refines them with antibody-specific language models. By integrating early-stage off-target screening and AlphaFold validation, CelAbGen compresses discovery timelines from years to weeks.',
    ...
    },
    {
      ...
      description: 'Master\'s Thesis investigating RORγt structural dynamics and ligand binding mechanisms. High-throughput molecular docking, Prime MM-GBSA analysis, and extensive all-atom molecular dynamics via AMBER22 were utilized to decipher critical structural determinants, paving the way for targeted autoimmune disease inhibitors.',
      tags: ['AMBER22', 'MD Simulations', 'MM-GBSA', 'Docking'],
      color: 'var(--accent-purple)',
      image: import.meta.env.BASE_URL + 'roryt.png',
      links: [
        { label: 'Read Thesis', href: import.meta.env.BASE_URL + 'shantanu_thesis.pdf' }
      ]
    },
    {
    ...
    },
    {
      ...
      color: 'var(--accent-cyan)',
      image: import.meta.env.BASE_URL + 'p110.png',
      links: []
    },
    {
